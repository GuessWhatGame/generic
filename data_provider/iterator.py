...
#     return batch
#
# class SemaphoreIterator(object):
#     def __init__(self, it, semaphores):
#         self.it = it
...
#         if pool is not None:
#             it_batch = sem_iterator(l=batch, sem=self.semaphores)
#             process_iterator = pool.imap(batchifier.apply, it_batch)
#             self.it = SemaphoreIterator(process_iterator, self.semaphores)
#         else:
#             self.it = ( batchifier.apply(b) for b in batch )
#
#     def __len__(self):
